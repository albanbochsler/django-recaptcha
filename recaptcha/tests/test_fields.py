...
from recaptcha import fields, widgets
from recaptcha.client import RecaptchaResponse
...
class TestFields(TestCase):
    @patch("recaptcha.fields.client.submit")
    ...
    @patch("recaptcha.client.recaptcha_request")
...
class TestWidgets(TestCase):
    @patch("recaptcha.widgets.uuid.UUID.hex", new_callable=PropertyMock)
