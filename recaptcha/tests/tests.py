...
class TestInit(TestCase):
    ...
    @override_settings(RECAPTCHA_PRIVATE_KEY=recaptcha.constants.TEST_PRIVATE_KEY)
    def test_test_key_check(self):
        check_errors = recaptcha.checks.recaptcha_key_check("someconf")
        expected_errors = [
            Error(
                ...
                " ['recaptcha.recaptcha_test_key_error']`"
                " to your settings file.",
                id="recaptcha.recaptcha_test_key_error",
            )
        ]
