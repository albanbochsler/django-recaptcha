...
from recaptcha import client
from recaptcha.constants import TEST_PRIVATE_KEY, TEST_PUBLIC_KEY
from recaptcha.widgets import ReCaptchaBase, ReCaptchaV2Checkbox
    ...
    def __init__(self, public_key=None, private_key=None, *args, **kwargs):
        ...
        if not isinstance(self.widget, ReCaptchaBase):
            raise ImproperlyConfigured(
                "recaptcha.fields.ReCaptchaField.widget"
                " must be a subclass of recaptcha.widgets.ReCaptchaBase"
            )
